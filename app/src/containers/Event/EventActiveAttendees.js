  ...
  async getEventInformation(eventKey, hostId, navStackDepth, isHostUser) {
    ...
    if (eventData && hostUserData && currentUserFriends) {
      ...
      this.setState({
        ...
        hostProfileImgUrl: hostUserData.profileImgUrl || "",
        animating: false,
        currentNavStackDepth: navStackDepth + 1
      });
              ...
              <Left style={{ flex: 0.5 }}>
                ...
                >
                  {this.state.eventData && this.state.hostProfileImgUrl ? (
                    <Image
                      source={{ uri: this.state.hostProfileImgUrl }}
        ...
        <View style={{ position: "relative", left: 16 }}>
          <ScrollView horizontal={true}>
            <View>
              ...
              >
                <Text ref="textForStatusAll" style={styles.btnGroupTxt}>
                  All
                </Text>
              </TouchableOpacity>
              <View
            ...
            <View>
              ...
              >
                <Text ref="textForStatusAccepted" style={styles.btnGroupTxt}>
                  Accepted
                </Text>
              </TouchableOpacity>
              <View
            ...
            <View>
              ...
              >
                <Text ref="textForStatusInvited" style={styles.btnGroupTxt}>
                  Maybe
                </Text>
              </TouchableOpacity>
              <View
            ...
            <View>
              ...
              >
                <Text ref="textForStatusDeclined" style={styles.btnGroupTxt}>
                  Declined
                </Text>
              </TouchableOpacity>
              <View
            ...
            <View>
              ...
              >
                <Text ref="textForStatusFriends" style={styles.btnGroupTxt}>
                  Friends
                </Text>
              </TouchableOpacity>
              <View
