        ...
        <Content>
          <View style={{ padding: 15 }}>
            <Text style={styles.textStyle}>
              Hey, you downloaded the hoozin app! We’re happy you’re trying out
              our app and we’re also pretty open to feedback here at hoozin. We
              are always interested in getting user input so that we can make
              this product better. Please keep in mind that this is out beta
              release. We have a lot of features and ideas we plan on adding in
              the future, so go easy on us. We will review your message and see
              if it will make sense in our product roadmap. If you would like,
              leave your email address and we will try our best to respond.
            </Text>
          </View>
          <View style={{ padding: 15 }}>
            <TextInput
...
const mapDispatchToProps = dispatch => {
  return {
    insertFeedback: (email, feedbackText, uid, timestamp) => {
      dispatch(insertFeedbackAction(email, feedbackText, uid, timestamp));
    },
